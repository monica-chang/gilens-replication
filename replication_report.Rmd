...
some predictive difference. When the president is Democratic, proposed policy
...
party of the President and preferences of average citizens. I was curious about 
whether there was any differential responsiveness by the different parties to 
the average citizen.
...
It appears that after adding this interaction, the coefficient for both 
party_pres and the interaction coefficient are no longer statistically
significant. #ASK: Why does statistical significance change?

The party_pres coefficient represents the influence of the party of the 
President on policy outcomes when pred50_norm is equal to 0 - that is, when the 
average citizen is completely opposed to a given policy. 

The pred50_norm:party_pres coefficient represents the change in pred50_norm
if the party of the President goes from Democrat to Republican.

To more easily interpret these coefficients, we can convert to predicted 
probabilities.
...
to be associated with more responsiveness to the average citizen.

## Conclusion

summarizing your work, important findings, limitations, etc.?
– You may also want to discuss whether there are some future directions you want to explore in this part.
