...
The authors get the following findings from this table:

- The preferences of average citizens are positively and fairly highly 
correlated, across issues, with the preferences of economic elites. This means
...
The authors get four main findings:
...
The authors get three main findings:
...
theparty of the President in the year of the survey question was a Democrat or a 
...
stargazer(model_7,
          title = "Table 5. The impact of the party of the President on policy outcomes",
          align = TRUE,
          dep.var.labels = c("Policy change"),
          covariate.labels = c("Average citizens’ preferences", 
                               "Economic elites’ preferences", 
...
When one holds the preferences of average citizens, economic elites, and
...
party of the President and preferences of average citizens. In Unequal Democracy,
Larry Bartels finds a strong impact of partisan control on the minimum wage 
(with the minimum wage keeping pace with inflation during Democratic 
administrations but declining during Republican administrations). This would 
seem to suggest that Democratic administrations are more responsive to the
average citizen. I was curious about whether there was any differential 
responsiveness by the different parties to the average citizen based on this 
dataset.
...
- When the president is Democratic and the 1 out of 5 average citizens favors 
the proposed policy change, the policy is adopted 60% of the time.

- When the president is Democratic and the 4 out of 5 average citizens favors 
the proposed policy change, the policy is adopted 45% of the time.

- When the president is Republican and the 1 out of 5 average citizens favors 
the proposed policy change, the policy is adopted 60% of the time.

- When the president is Republican and the 4 out of 5 average citizens favors 
the proposed policy change, the policy is adopted 50% of the time.

It appears that Republican presidents are more responsive to the average
citizen. This is surprising - as I would have expected a Democratic president
to be associated with more responsiveness to the average citizen. In general,
...
individuals, associated with *less* governmental responsiveness to the average
citizen? Some additional research questions inspired by this puzzle:

- In what policy domains were Republicans more responsive to the average citizen?
- Is the Democratic Party out of touch with what the average citizen wants in 
terms of social policies?
- How different are preferences on redistributive policies between average 
citizens and affluent voters? 
...
the average citizen. In my analyses, the preferences of the average citizen had 
...
average citizen by the different parties. I surprisingly found that
Republican presidents are more responsive to the average citizen.
